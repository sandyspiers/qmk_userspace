...
// │  Left home row:  mods  |  [G]=QK_LLCK to lock/unlock                        │
...
[NAV] = LAYOUT_split_3x6_3_ex2(
    ...
    TO(BASE), KC_LGUI, KC_LALT, KC_LCTL, KC_LSFT, QK_LLCK, KC_NO, KC_NO,   KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT, KC_END,  KC_PGDN,
...
// │  Left top row:  + - * / =                                                    │
// │  Left home row: GUI Alt Ctrl Shift                                           │
// │  [G] = QK_LLCK — tap to lock/unlock this layer                              │
// └──────────────────────────────────────────────────────────────────────────────┘
[NUM] = LAYOUT_split_3x6_3_ex2(
    KC_NO,    KC_PLUS, KC_MINS, KC_ASTR, KC_SLSH, KC_EQL,  KC_NO,  KC_NO,   KC_NO,  KC_7,   KC_8,   KC_9,    KC_NO,   KC_NO,
    TO(BASE), KC_LGUI, KC_LALT, KC_LCTL, KC_LSFT, QK_LLCK, KC_NO,  KC_NO,   KC_NO,  KC_4,   KC_5,   KC_6,    KC_0,    KC_NO,
...
// │  Left hand top row:  & * ~                                                  │
// │  Left hand home row: ` ^ % $                                                │
// │  Left hand bottom:   ! @ #   G = QK_LLCK to lock layer.                    │
// └──────────────────────────────────────────────────────────────────────────────┘
[SYM] = LAYOUT_split_3x6_3_ex2(
    ...
    TO(BASE), KC_GRV,  KC_CIRC, KC_PERC, KC_DLR,  QK_LLCK,  KC_NO,  KC_NO,   KC_NO,   KC_LPRN, KC_RPRN, KC_LABK, KC_RABK, KC_NO,
...
[MISC] = LAYOUT_split_3x6_3_ex2(
    ...
    TO(BASE), KC_F11,  KC_F4,  KC_F5,  KC_F6,  QK_LLCK,   KC_NO,  KC_NO,   KC_MPRV, KC_MPLY, KC_MNXT, KC_VOLD, KC_VOLU, KC_NO,
